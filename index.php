                ...
                <div class="modal-content">
                    <form class="pb-modalreglog-form-reg" action="" method="post">
                        ...
                        <div class="modal-body">
							...
							<p><img src="LoaderIcon.gif" id="loaderIcon" style="display:none" <!-- animacija    -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="checkbox" id="ch" name="ch"> I'm not a robot.
                            </div>
							<div class="form-group">
                                    <a data-toggle="modal" data-target="#myModal5" data-dismiss="modal"> Forgotten account?</a>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="cold-sm-5 text-center botuni">
                        <button class="loginBtn facebook"> Login with Facebook
                        </button>
